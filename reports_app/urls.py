...
from .views import (
    ...
    dashboard_list,
    dashboard_reject,
    dashboard_return_to_review,
    dashboard_restore,
    dashboard_review_attachments,
    dashboard_serve,
    dashboard_submit,
...
urlpatterns = [
    ...
    path(
        "dashboards/<int:pk>/return-to-review/",
        dashboard_return_to_review,
        name="dashboard_return_to_review",
    ),
    ...
    path(
        "dashboards/<int:pk>/review-attachments/",
        dashboard_review_attachments,
        name="dashboard_review_attachments",
    ),
