...
# Default (development/test): plain storage — runserver serves from assets/.
# Production overrides STORAGES["staticfiles"] to Manifest so {% static %}
# URLs include a content hash and browsers pick up deploys.
STORAGES = {
    "default": {
